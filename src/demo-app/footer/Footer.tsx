            ...
            <div className="grid-container">
                                ...
                                <Row gutter={10} className='footer-nav-links-row'>
                                    <Col span={12}>
                                        <ul>
                                            ...
                                            <li>
                                                <a href="/fundraisers-charities/" aria-label="Fundraisers page link">Fundraisers</a>
                                            </li>
                                            <li>
                                                <a href="/gift-cards/" aria-label="Gift Cards page link">Careers</a>
                                            </li>
                                        </ul>
                                    </Col>
                                    <Col span={12}>
                                        <ul>
                                            <li>
                                                <a href="/our-food/" aria-label="Menu page link">Franchising</a>
                                            </li>
                                            <li>
                                                <a href="/our-food/catering" aria-label="Catering page link">Investors</a>
                                            </li>
                                            <li>
                                                <a href="/gift-cards/" aria-label="Gift Cards page link">Press Releases</a>
                                            </li>
                                            <li>
                                                <a href="/fundraisers-charities/" aria-label="Fundraisers page link">Contact Us</a>
                                            </li>
                                            <li>
                                                <a href="/gift-cards/" aria-label="Gift Cards page link">Feedback</a>
                                            </li>
                                        </ul>
                                    </Col>
                                </Row>
                ...
                <div className="grid-x bottom-footer">
                    <div className="social medium-3 small-12 small-order-1 medium-order-1 text-left">
                        <a href="https://www.facebook.com/ElPolloLoco" rel="noopener noreferrer" target="_blank" className="icon-facebook" aria-label="facebook link"><i className="fa fa-facebook"></i></a>
                        <a href="https://twitter.com/ElPolloLoco" rel="noopener noreferrer" target="_blank" className="icon-twiter" aria-label="twitter link"><i className="fa fa-twitter"></i></a>
                        <a href="https://www.instagram.com/ElPolloLoco/" rel="noopener noreferrer" target="_blank" className="icon-instagram" aria-label="instagram link"><i className="fa fa-instagram"></i></a>
                        <a href="https://www.tiktok.com/@elpolloloco" rel="noopener noreferrer" target="_blank" className="icon-tiktok" aria-label="tiktok link"><i className=""></i></a>
                    </div>
                    <div className="legal medium-9 small-12 small-order-2 medium-order-2 text-right">
                        <ul className="footer-minor-links">
                            <li>
                                <a href="/content/pdfs/epl_web_nutrition_guide_mod_2_2024_hr-1.pdf" aria-label="Nutrition Guide PDF link">Nutrition Guide</a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="/legal/#ca-privacy-notice" aria-label="California Privacy Notice link">California Privacy Notice</a>
                            </li>
                            <li>
                            ...
                            <li className="footer-copyright-epl_disabled">
                                © El Pollo Loco. All Rights Reserved
                            </li>
                        </ul>
                    </div>
                </div>
