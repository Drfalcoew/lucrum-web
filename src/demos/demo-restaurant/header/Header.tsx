    ...
    return (
        <header className='demo-header'>
            <div className='demo-header-container'>
                <div className='demo-header-container-left' onClick={() => nav('demo/restaurant')}>
                ...
                <div className='demo-header-container-right'>
                    <button className='demo-header-button' onClick={() => nav('demo/restaurant/menu')}>MAIN MENU</button>
                </div>
            </div>
        </header>
    );
